...
import OfferHost from '../blocks/offer/OfferHost';
import OfferPrice from '../blocks/offer/OfferPrice';
import NearPlaces from '../blocks/offer/NearPlaces';
import OfferInside from '../blocks/offer/OfferInside';
import OfferRating from '../blocks/offer/OfferRating';
import OfferGallery from '../blocks/offer/OfferGallery';
import OfferFeatures from '../blocks/offer/OfferFeatures';
import OfferMarkPremium from '../blocks/offer/OfferMarkPremium';
import OfferBookmarkButton from '../blocks/offer/OfferBookmarkButton';

export default function Offer({ hasAccess }: { hasAccess: AuthStatus }) {
  const { id, city } = useParams();
  const { setActivePointPlace } = useTypedActions();
  const { data: offer, isLoading } = useGetOfferQuery(id as string, { skip: !id }); // useGetOffersQuery();
